...
export default async function SpaceLayout({
  ...
  return (
    <div className="doc-shell lg:grid lg:min-h-[calc(100vh-var(--bar))] lg:grid-cols-[264px_minmax(0,1fr)]">
      ...
      <aside className="doc-tree border-line bg-chrome flex flex-col gap-3 border-b px-4 py-4 lg:sticky lg:top-0 lg:h-[calc(100vh-var(--bar))] lg:border-r lg:border-b-0">
        <Link
          href="/docs"
