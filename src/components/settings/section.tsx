 ...
 * the left, the control on the right, a hairline underneath. Flush rather than
...
export function SettingsSection({
  ...
  return (
    <section className="border-line grid gap-4 border-b py-6 first:pt-0 last:border-b-0 lg:grid-cols-[220px_minmax(0,1fr)] lg:gap-8">
